...
export async function loadCore({ wasmUrl = DEFAULT_WASM_URL } = {}) {
  ...
  return {
    ...
    getAmbientOutcomeCode: exports.getAmbientOutcomeCode,
    getAmbientOutcomeAffinityKind: exports.getAmbientOutcomeAffinityKind,
    getAmbientOutcomeExpression: exports.getAmbientOutcomeExpression,
    getAmbientOutcomePower: exports.getAmbientOutcomePower,
    getAmbientOutcomeTargetVital: exports.getAmbientOutcomeTargetVital,
    getAmbientOutcomeDelta: exports.getAmbientOutcomeDelta,
