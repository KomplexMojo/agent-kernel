...
export function createOrchestratorStateMachine({ initialState = OrchestratorStates.IDLE, clock }: { initialState?: string; clock: () => string } = {} as any) {
  if (typeof clock !== "function") throw new TypeError("createOrchestratorStateMachine: clock must be injected as a function");
