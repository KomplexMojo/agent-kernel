import { createOrchestratorStateMachine, OrchestratorStates } from "./state-machine.mts";
...
export function createOrchestratorPersona({ initialState = OrchestratorStates.IDLE, clock }: { initialState?: string; clock: () => string } = {} as any) {
