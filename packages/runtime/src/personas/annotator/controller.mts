import { createAnnotatorStateMachine, AnnotatorStates } from "./state-machine.mts";
...
export function createAnnotatorPersona({ initialState = AnnotatorStates.IDLE, clock }: { initialState?: string; clock: () => string } = {} as any) {
