...
export function createAllocatorStateMachine({ initialState = AllocatorStates.IDLE, clock }: { initialState?: string; clock: () => string } = {} as any) {
  if (typeof clock !== "function") throw new TypeError("createAllocatorStateMachine: clock must be injected as a function");
