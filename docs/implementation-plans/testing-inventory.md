...
- [pending] llm (Ollama-style HTTP) — packages/adapters-web/src/adapters/llm/index.js
...
- [pending] llm (Ollama-style HTTP) — packages/adapters-cli/src/adapters/llm/index.js
...
- [pending] llm (Ollama-style HTTP) — packages/adapters-test/src/adapters/llm/index.js
