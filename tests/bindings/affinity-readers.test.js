...
// ── WASM affinity exports through bindings ──
...
console.log("affinity-readers: all assertions passed");
`;

test("affinity bindings: code maps, readAffinityFieldAt, readAffinityInteractionResult, readActorAffinity", (t) => {
...
// - [ ] WASM codebook exports: all affinity codebook functions callable through bindings
